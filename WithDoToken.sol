...
contract WithDoToken is Context, IERC20 {
    ...
    /* function minter() public view external returns (address _minter){
        return _minter;
    } */
    ...
    */
    ...
    modifier onlyMinter {
        require(_msgSender() == _minter,"ERC20: ERC20: address is not allow to mint"); // Check if the caller is a minter address
        _;
    }
